...
//   const [newAccountType, setNewAccountType] = useState<string>("credit_card");
//   const [newBillingDay, setNewBillingDay] = useState<string>("1");
//   const [newGracePeriod, setNewGracePeriod] = useState<string>("20");
...
//       return;
//     }
//     if (!allowedTypes.includes(newAccountType)) {
//       Alert.alert(
//         "Validation",
//         `Type must be one of: ${allowedTypes.join(", ")}`
//       );
...
//     }
//     if (
//       isNaN(Number(newBillingDay)) ||
//       Number(newBillingDay) < 1 ||
//       Number(newBillingDay) > 31
//     ) {
//       Alert.alert(
//         "Validation",
//         "Billing day must be a number between 1 and 31"
...
//       return;
//     }
//     if (isNaN(Number(newGracePeriod)) || Number(newGracePeriod) < 0) {
//       Alert.alert("Validation", "Grace period must be a non-negative number");
//       return;
//     }
...
//           grace_period_days: Number(newGracePeriod),
//           active: newActive,
//         },
//         {
//           headers: {
...
//   return (
//     <SafeAreaView className="flex-1 bg-gray-50 dark:bg-gray-900 px-4 pt-6">
//       <Text className="text-2xl font-bold text-gray-800 dark:text-white mb-4">
//         Accounts
//       </Text>
...
//       <TouchableOpacity
//         onPress={() => setModalVisible(true)}
//         className="bg-green-600 px-5 py-3 rounded-full absolute bottom-24 right-8 shadow-lg"
//       >
//         <Text className="text-white text-lg font-semibold">Add Account</Text>
//       </TouchableOpacity>

//       <TouchableOpacity
//         onPress={fetchAccounts}
//         className="bg-blue-600 px-5 py-3 rounded-full absolute bottom-8 right-8 shadow-lg"
//       >
//         <Text className="text-white text-lg font-semibold">Reload</Text>
//       </TouchableOpacity>
...
//                 <TouchableOpacity
//                   key={typeOption}
//                   onPress={() => setNewAccountType(typeOption)}
//                   className={`px-3 py-1 mr-2 mb-2 rounded-md border ${
...
//               onChangeText={setNewGracePeriod}
//               keyboardType="number-pad"
//               className="bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white rounded-md px-3 py-2 mb-4"
//               maxLength={3}
//             />
...
//             <View className="flex-row items-center mb-4">
//               <Text className="text-gray-900 dark:text-white mr-4">Active</Text>
//               <TouchableOpacity onPress={() => setNewActive(!newActive)}>
//                 <View
//                   className={`w-10 h-6 rounded-full ${
//                     newActive ? "bg-green-500" : "bg-gray-400"
//                   }`}
//                 >
//                   <View
//                     className={`w-5 h-5 rounded-full bg-white mt-0.5 ml-${
...
//             <TextInput
//               placeholder="Type (e.g. credit_card)"
...
//               <TouchableOpacity onPress={() => setNewActive(!newActive)}>
//                 <View
//                   className={`w-10 h-6 rounded-full ${newActive ? "bg-green-500" : "bg-gray-400"}`}
//                 >
//                   <View
//                     className={`w-5 h-5 rounded-full bg-white mt-0.5 ml-${
//                       newActive ? "5" : "0"
