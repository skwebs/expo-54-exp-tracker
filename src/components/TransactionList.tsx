...
export default function TransactionList({
  ...
  const renderSectionHeader = ({
    ...
    >
      <Text className="rounded-3xl border border-gray-100 bg-white px-4 py-1.5 text-center text-sm text-gray-600 shadow dark:border-gray-700 dark:bg-gray-800/80 dark:text-gray-300">
        {section.title}
      </Text>
    </Animated.View>
  );
        ...
        <View className="flex-row items-center justify-between">
          <View className="mr-3 flex-1">
            ...
            <View className="mt-2 flex-row items-center gap-2">
              {item.category && (
                <View className="rounded bg-orange-100 px-2 py-1 dark:bg-orange-900/30">
    ...
    <View className="flex-1">
      ...
      {currentStickyDate && (
        <Animated.View
          ...
          className="absolute top-1 z-50 self-center rounded-full  border border-gray-100 bg-white px-4 py-2 shadow dark:border-gray-700 dark:bg-gray-800/90"
          pointerEvents="none"
        >
